...
export const CATEGORIES: CategoryConfig[] = [
  ...
  },
  {
    ...
    subcategories: [{ slug: 'medisin', label: 'Medisin' }, { slug: 'diabetes', label: 'Diabetes' }, { slug: 'hjerte', label: 'Hjerte og kar' }, { slug: 'kreft', label: 'Kreft' }, { slug: 'muskel-og-skjelett', label: 'Muskel og skjelett' }, { slug: 'ernaering', label: 'Ernæring' }, { slug: 'mental-helse', label: 'Mental helse' }, { slug: 'kroppen', label: 'Kroppen' }, { slug: 'trening', label: 'Trening' }],
  },
  {
