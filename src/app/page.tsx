...
const CAT_ICONS: Record<string, React.ReactNode> = {
  ...
  seo: <svg width="22" height="22" viewBox="0 0 22 22" fill="none"><circle cx="9.5" cy="9.5" r="6" stroke="currentColor" strokeWidth="1.5"/><line x1="14" y1="14" x2="19" y2="19" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/><path d="M6.5 11L9 7.5L11.5 11" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round"/></svg>,
  okonomi: <svg width="22" height="22" viewBox="0 0 22 22" fill="none"><path d="M4 17V10M8 17V8M12 17V5M16 17V9M20 17V7" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/></svg>,
  ...
  handel: <svg width="22" height="22" viewBox="0 0 22 22" fill="none"><path d="M3 5H5L7.5 15H17" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/><circle cx="9" cy="18" r="1.5" stroke="currentColor" strokeWidth="1.3"/><circle cx="15.5" cy="18" r="1.5" stroke="currentColor" strokeWidth="1.3"/><path d="M7.5 8H18L16.5 13H8.5" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round"/></svg>,
  bolig: <svg width="22" height="22" viewBox="0 0 22 22" fill="none"><path d="M3 11L11 4L19 11" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/><path d="M5.5 12.5V19H9.5V15H12.5V19H16.5V12.5" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round"/></svg>,
  jobb: <svg width="22" height="22" viewBox="0 0 22 22" fill="none"><rect x="2.5" y="8" width="17" height="10" rx="1.5" stroke="currentColor" strokeWidth="1.5"/><path d="M8 8V6C8 4.9 8.9 4 10 4H12C13.1 4 14 4.9 14 6V8" stroke="currentColor" strokeWidth="1.5"/><line x1="2.5" y1="13" x2="19.5" y2="13" stroke="currentColor" strokeWidth="1.2"/></svg>,
  sport: <svg width="22" height="22" viewBox="0 0 22 22" fill="none"><circle cx="11" cy="11" r="8" stroke="currentColor" strokeWidth="1.5"/><path d="M11 3V19M3 11H19" stroke="currentColor" strokeWidth="1"/><path d="M5.5 4C8 7 8 15 5.5 18M16.5 4C14 7 14 15 16.5 18" stroke="currentColor" strokeWidth="1"/></svg>,
  underholdning: <svg width="22" height="22" viewBox="0 0 22 22" fill="none"><rect x="3" y="5" width="16" height="10" rx="1.5" stroke="currentColor" strokeWidth="1.5"/><polygon points="9,8 9,12 13,10" fill="currentColor"/><line x1="7" y1="18" x2="15" y2="18" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/><line x1="11" y1="15" x2="11" y2="18" stroke="currentColor" strokeWidth="1.5"/></svg>,
};
