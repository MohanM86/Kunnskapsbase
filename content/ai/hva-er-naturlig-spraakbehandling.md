...
draft: false
entityType: "Concept"
topic: "Naturlig språkbehandling"
aliases: ["NLP", "natural language processing", "språkteknologi"]
related: ["hva-er-store-spraakmodeller", "hva-er-kunstig-intelligens", "hva-er-maskinlaering", "hva-er-chatgpt", "hva-er-dyp-laering"]
seeAlso: ["hva-er-prompt-engineering", "hva-er-hallusinering-i-ai"]
tags: ["NLP", "språkbehandling", "AI", "tekstanalyse"]
...
> **Kort forklart**
> NLP er teknologien som lar datamaskiner «forstå» tekst og tale. Det er det som gjør at du kan snakke med Siri, bruke Google Translate eller chatte med ChatGPT.
...
- [Store språkmodeller](/ai/hva-er-store-spraakmodeller) – den mest avanserte NLP-teknologien i dag
- [Kunstig intelligens](/ai/hva-er-kunstig-intelligens) – det overordnede feltet NLP tilhører
- [Maskinlæring](/ai/hva-er-maskinlaering) – metoden som driver moderne NLP-systemer
- [ChatGPT](/ai/hva-er-chatgpt) – en AI-chatbot bygget på NLP-teknologi
- [Dyp læring](/ai/hva-er-dyp-laering) – teknologien som revolusjonerte NLP-feltet
- [Hallusinering i AI](/ai/hva-er-hallusinering-i-ai) – en kjent utfordring innen NLP-generert tekst

## Se også

- [Hva er prompt engineering?](/ai/hva-er-prompt-engineering)
- [Hva er hallusinering i AI?](/ai/hva-er-hallusinering-i-ai)
