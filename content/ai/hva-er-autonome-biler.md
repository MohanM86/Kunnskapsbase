...
draft: false
entityType: "Concept"
topic: "Autonome biler"
aliases: ["selvkjørende biler", "self-driving cars", "AI-kjøring", "autonom kjøring"]
related: ["hva-er-kunstig-intelligens", "hva-er-nevrale-nettverk", "hva-er-maskinlaering"]
seeAlso: ["hva-er-ai-sikkerhet", "hva-er-ai-regulering"]
tags: ["autonome biler", "selvkjøring", "Tesla", "Waymo"]
...
> **Kort forklart**
> Autonome biler bruker AI for å «se» veien, forstå trafikksituasjonen og ta kjørebeslutninger – fra å holde feltet på motorveien til å navigere komplekse bykryss helt uten fører.
...
### Finnes det helt selvkjørende biler i dag?
Ja, men bare i avgrensede områder. Waymo tilbyr førerløse taxiturer i utvalgte amerikanske byer. Utenfor disse områdene finnes det ingen biler som kjører helt selv overalt.

### Er Tesla Full Self-Driving virkelig selvkjørende?
Nei. Tross navnet er det et nivå 2-system som krever at føreren holder oppmerksomheten på veien og kan ta over når som helst. Navnet er misvisende.

### Når kommer selvkjørende biler til Norge?
Nivå 2-systemer som Tesla Autopilot er allerede tilgjengelig. Nivå 3 og 4 avhenger av regulering og teknologisk modenhet for norske vinterforhold. Realistisk tidslinje er 5–10 år for begrenset bruk.

### Er autonome biler sikre?
Waymos data viser at deres biler har færre ulykker enn menneskelige sjåfører. Men teknologien er ikke perfekt – sjeldne feil kan skje. Sikkerheten forbedres kontinuerlig med mer data og bedre AI.
