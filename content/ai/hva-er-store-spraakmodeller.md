...
draft: false
entityType: "Concept"
topic: "Store språkmodeller"
aliases: ["LLM", "large language model", "språkmodell"]
related: ["hva-er-kunstig-intelligens", "hva-er-maskinlaering", "hva-er-chatgpt", "hva-er-nevrale-nettverk", "hva-er-prompt-engineering"]
seeAlso: ["hva-er-ai-agenter"]
tags: ["LLM", "språkmodell", "AI", "NLP"]
...
> **Kort forklart**
> Store språkmodeller er AI-programmer som har «lest» store deler av internett og kan skrive tekst, svare på spørsmål, oversette språk og løse oppgaver basert på det de har lært.
...
- [Kunstig intelligens](/ai/hva-er-kunstig-intelligens) – det overordnede feltet språkmodeller tilhører
- [Maskinlæring](/ai/hva-er-maskinlaering) – metoden som brukes for å trene språkmodeller
- [Nevrale nettverk](/ai/hva-er-nevrale-nettverk) – beregningsstrukturen språkmodeller er bygget på
- [ChatGPT](/ai/hva-er-chatgpt) – en populær chatbot drevet av en stor språkmodell
- [Prompt engineering](/ai/hva-er-prompt-engineering) – teknikker for å få bedre resultater fra språkmodeller
- [AI-agenter](/ai/hva-er-ai-agenter) – autonome systemer som ofte bruker språkmodeller som kjerne
