...
related: ["hva-er-kunstig-intelligens", "hva-er-nevrale-nettverk", "hva-er-store-spraakmodeller", "hva-er-prompt-engineering"]
seeAlso: ["hva-er-ai-agenter", "hva-er-chatgpt"]
tags: ["maskinlæring", "AI", "algoritmer", "data"]
...
> **Kort forklart**
> Maskinlæring lar datamaskiner oppdage mønstre i data og ta beslutninger basert på det de har lært, i stedet for å følge forhåndsdefinerte regler.
...
- [Kunstig intelligens](/ai/hva-er-kunstig-intelligens) – det overordnede feltet maskinlæring tilhører
- [Nevrale nettverk](/ai/hva-er-nevrale-nettverk) – beregningsmodell inspirert av hjernen, brukt i dyp læring
- [Store språkmodeller](/ai/hva-er-store-spraakmodeller) – AI-modeller trent med maskinlæring på store tekstmengder
- [Prompt engineering](/ai/hva-er-prompt-engineering) – teknikk for å kommunisere effektivt med AI-modeller
- [AI-agenter](/ai/hva-er-ai-agenter) – autonome systemer som bruker maskinlæring til å handle
